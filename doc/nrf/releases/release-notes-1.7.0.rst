...
* Software support for :ref:`zephyr:thingy53_nrf5340`:
  ...
  * :ref:`Matter weather station <matter_weather_station_app>` application, supported for development.
  * Bluetooth® samples:
...
* Added Wi-Fi coexistance feature supported for development for Thread and Zigbee.
